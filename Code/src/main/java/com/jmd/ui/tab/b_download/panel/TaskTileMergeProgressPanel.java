...
@Component
public class TaskTileMergeProgressPanel extends JPanel {
    ...
    public TaskTileMergeProgressPanel() {
    ...
    private void subInnerMqMessage() throws Exception {
        ...
        this.client.<String>sub(Topic.TASK_TILE_MERGE_PROCESS_PIXEL_COUNT, (res) -> {
            SwingUtilities.invokeLater(() -> pixelCountValueLabel.setText(res));
        });
        this.client.<String>sub(Topic.TASK_TILE_MERGE_PROCESS_THREAD, (res) -> {
            SwingUtilities.invokeLater(() -> threadCountValueLabel.setText(res));
        });
        this.client.<String>sub(Topic.TASK_TILE_MERGE_PROCESS_PROGRESS, (res) -> {
            SwingUtilities.invokeLater(() -> mergeProgressValueLabel.setText(res));
        });
        this.client.sub(Topic.TASK_TILE_MERGE_PROCESS_CLEAR, (res) -> {
